...
const Sidebar = () => {
  ...
  const renderChatItemSkeleton = (index) => (
  ...
  const renderChatItem = (chat, index) => (
    ...
    >
      ...
      <div className="ml-2 flex flex-col flex-1 min-w-0 justify-center">
        ...
        <div className="flex items-center truncate">
          <span
            className={`truncate ${isdark ? "text-gray-300" : "text-gray-800"}`}
          >
            {(() => {
              const message = chatsList.find((msg) => msg.chatId === chat.id);
